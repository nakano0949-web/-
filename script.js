// --- データベース ---
const familyCandidates = ["ナス科","アブラナ科","マメ科","イネ科","ヒユ科","セリ科","キク科","ウリ科","バラ科","シソ科","ヒガンバナ科","ショウガ科","サトイモ科","ヒルガオ科","アオイ科","ヤマノイモ科","キジカクシ科","アカザ科","オモダカ科","ミカン科","ブドウ科"];

const familyToVeg = {
  "ナス科": ["トマト","ナス","ピーマン","ジャガイモ"],
  "アブラナ科": ["キャベツ","白菜","ブロッコリー","大根","小松菜"],
  "マメ科": ["枝豆","インゲン","サヤエンドウ","ソラマメ"],
  "イネ科": ["トウモロコシ","麦"],
  "ヒユ科": ["ほうれん草","ビーツ"],
  "セリ科": ["ニンジン","パセリ","セロリ"],
  "キク科": ["レタス","春菊","ゴボウ"],
  ...
  "バラ科": ["イチゴ"],
  "シソ科": ["シソ","バジル"],
  "ヒガンバナ科": ["アサツキ","長ネギ","玉ねぎ","ニラ","ワケギ","らっきょう","にんにく"],
  "ショウガ科": ["ショウガ"],
  "サトイモ科": ["サトイモ","コンニャク","タロイモ"],
  "ヒルガオ科": ["サツマイモ"],
  "ヤマノイモ科": ["ヤマイモ"],
  "アオイ科": ["オクラ"],
  "キジカクシ科": ["アスパラガス"],
  "アカザ科": ["ビート","キヌア"],
  "オモダカ科": ["クワイ"],
  "ミカン科": ["ミカン","オレンジ","レモン","グレープフルーツ","ユズ","カボス","スダチ","シークワーサー","ポンカン","デコポン","伊予柑","文旦","八朔","夏ミカン"],
  "ブドウ科": ["ブドウ","ヤマブドウ","エビヅル","ノブドウ","ツタ"]
};

const familyInfo = {
  "ナス科": { desc:"連作障害が強い。3〜4年空ける。", soil:"弱酸性〜中性", pests:"アブラムシ", rotation:"3〜4年", good:["ヒガンバナ科"], bad:["ナス科"] },
  "アブラナ科": { desc:"根こぶ病に注意。2〜3年空ける。", soil:"pH6.5以上", pests:"コナガ", rotation:"2〜3年", good:["ヒガンバナ科"], bad:["アブラナ科"] },
  "マメ科": { desc:"窒素固定で土を肥やす。", soil:"乾燥気味", pests:"カメムシ", rotation:"1〜2年", good:["ナス科"], bad:["マメ科"] },
  "イネ科": { desc:"根が深く土壌改良に役立つ。", soil:"中性", pests:"アワノメイガ", rotation:"1〜2年", good:["マメ科"], bad:["イネ科"] },
  "ヒユ科": { desc:"耐寒性が強く育てやすい。", soil:"弱酸性〜中性", pests:"アブラムシ", rotation:"1〜2年", good:["セリ科"], bad:["ヒユ科"] },
  "セリ科": { desc:"根が細く連作に弱い。", soil:"やや湿り気", pests:"キアゲハ幼虫", rotation:"2〜3年", good:["ヒユ科"], bad:["セリ科"] },
  "キク科": { desc:"連作障害は比較的少ない。", soil:"弱酸性〜中性", pests:"アブラムシ", rotation:"1〜2年", good:["ウリ科"], bad:["キク科"] },
  "ウリ科": { desc:"つる性で肥沃な土を好む。", soil:"中性〜弱アルカリ", pests:"ウリハムシ", rotation:"2〜3年", good:["マメ科"], bad:["ウリ科"] },
